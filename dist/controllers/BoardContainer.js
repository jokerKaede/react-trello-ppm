...
class BoardContainer extends _react.Component {
  ...
  get groupName() {
    ...
    return id ? id : "TrelloBoard".concat(new Date().getTime());
  }
  ...
  render() {
    ...
    return _react.default.createElement(components.BoardWrapper, (0, _extends2.default)({
      ...
      const laneToRender = _react.default.createElement(_Lane.default, (0, _extends2.default)({
        ...
        updateLaneScrollPosition: this.props.updateLaneScrollPosition
...
const mapDispatchToProps = dispatch => ({
  actions: (0, _redux.bindActionCreators)(_objectSpread({}, boardActions, {}, laneActions), dispatch)
});
